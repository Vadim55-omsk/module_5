...
#         self.password = self.hash(password)  # Хеширование пароля
#         #  # Атрибут класса User: age(возраст, число)
#         self.age = age
#
#         # Функция хеширования пароля.
#     def hash(self, password):  # https://docs.python.org/3/library/hashlib.html
...
# ur.register('vasya_pupkin', 'mcvndksjfGf', 13)
# ur.watch_video('Для чего девушкам парень программист?')
# # Вывод: Вам нет 18 лет, пожалуйста покиньте страницу
# ur.register('urban_pythonist', 'ghkjfJKklkf', 25)
# ur.watch_video('Для чего девушкам парень программист?')
